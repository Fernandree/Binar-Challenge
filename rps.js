...
class Stone extends Games {
    constructor(name,type){
        ...
        if(this.type == 'Player'){
            ...
            div_batu_player.innerHTML += "<img src='assets/batu.png' alt='Batu' style='width: 50px;height:75px;'>";
        }else{
            let div_batu_cpu = document.getElementById('batu_cpu');
            div_batu_cpu.innerHTML += "<img src='assets/batu.png' alt='Batu' style='width: 50px;height:75px;'>";
        }
    }
...
class Scissors extends Games{
    constructor(name,type){
        ...
        if(this.type == 'Player'){
            ...
            div_gunting_player.innerHTML += "<img src='assets/gunting.png' alt='gunting' style='width: 50px; height:75px;'>";
        }else{
            let div_gunting_cpu = document.getElementById('gunting_cpu');
            div_gunting_cpu.innerHTML += "<img src='assets/gunting.png' alt='gunting' style='width: 50px; height:75px;'>";
        }
    }
    victory(){
        document.getElementById('result').classList.add('banner');
...
class Paper extends Games {
    constructor(name,type){
        ...
        if(this.type == 'Player'){
            ...
            div_kertas_player.innerHTML += "<img src='assets/kertas.png' alt='kertas' style='width: 50px;height:75px;'>";
        }else{
            let div_kertas_cpu = document.getElementById('kertas_cpu');
            div_kertas_cpu.innerHTML += "<img src='assets/kertas.png' alt='kertas' style='width: 50px;height:75px;'>";
        }
    }    
    victory(){
        document.getElementById('result').classList.add('banner');
